...
class NotificationService {
    ...
    createNotification(content, type, translateParams, templateContext) {
        ...
        return {
            ...
            type,
            translateParams,
            templateContext: templateContext !== null && templateContext !== void 0 ? templateContext : {},
...
class ChatClientService {
    ...
    getAppSettings() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const settings = yield this.appSettingsPromise;
    ...
    updatePendingInvites(e) {
        ...
        if (((_b = (_a = e.member) === null || _a === void 0 ? void 0 : _a.user) === null || _b === void 0 ? void 0 : _b.id) === ((_c = this.chatClient.user) === null || _c === void 0 ? void 0 : _c.id) && e.channel) {
            ...
            if (e.type === 'notification.invited') {
                const channel = this.chatClient.channel((_d = e.channel) === null || _d === void 0 ? void 0 : _d.type, (_e = e.channel) === null || _e === void 0 ? void 0 : _e.id);
...
class ChannelQuery {
    ...
    query(queryType) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const channels = yield this.chatService.chatClient.queryChannels(filters, this.sort || {}, options);
...
class ChannelService {
            ...
            for (let i = 0; i < channels.length; i++) {
                ...
                if (deletedChannels.includes(channel)) {
                    if (shouldStopWatchingRemovedChannels) {
                        ...
                        void ((_a = this.chatClientService.chatClient.activeChannels[channel.cid]) === null || _a === void 0 ? void 0 : _a.stopWatching().catch((err) => this.chatClientService.chatClient.logger('warn', 'Failed to unwatch channel', err)));
                    }
                }
            }
            const nextChannels = channels;
            this.channelsSubject.next(nextChannels);
            if (!nextChannels.find((c) => { var _a; return c.cid === ((_a = this.activeChannelSubject.getValue()) === null || _a === void 0 ? void 0 : _a.cid); })) {
    ...
    init(filters, sort, options, shouldSetActiveChannel = true) {
        var _a;
        this.channelQuery = new ChannelQuery(this.chatClientService, this, filters, sort || { last_message_at: -1 }, Object.assign({ limit: 25, state: true, presence: true, watch: true, message_limit: this.messagePageSize }, options));
        this.channelQuery.customPaginator = this._customPaginator;
        return this._init({
            shouldSetActiveChannel,
            messagePageSize: (_a = options === null || options === void 0 ? void 0 : options.message_limit) !== null && _a !== void 0 ? _a : this.messagePageSize,
        });
    }
    /**
    ...
    loadMoreChannels() {
        return __awaiter(this, void 0, void 0, function* () {
            yield this.queryChannels(false, 'next-page');
        });
    }
    /**
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            uploadResults.forEach((uploadResult, i) => {
                ...
                if (uploadResult.status === 'fulfilled') {
                    ...
                    if (code === 22 ||
                        (code === 4 && ((_e = message === null || message === void 0 ? void 0 : message.toLowerCase()) === null || _e === void 0 ? void 0 : _e.includes('bytes')))) {
                        reason = 'file-size';
                        extraData = {
                            param: ((_f = /\d+MB|\d+\s?bytes/.exec(message || '')) === null || _f === void 0 ? void 0 : _f[0]) ||
                                `${this.attachmentMaxSizeFallbackInMB}MB`,
                        };
                        if (extraData.param.includes('bytes')) {
                            const limitInBytes = +(((_g = /\d+/.exec(extraData.param)) === null || _g === void 0 ? void 0 : _g[0]) ||
                                this.attachmentMaxSizeFallbackInMB * 1024 * 1024);
                            extraData.param = `${limitInBytes / (1024 * 1024)}MB`;
                        }
                    }
                    else if (code === 4 &&
                        ((_h = message === null || message === void 0 ? void 0 : message.toLowerCase()) === null || _h === void 0 ? void 0 : _h.includes('file extension'))) {
                        reason = 'file-extension';
                        extraData = { param: ((_j = /\.\w+/.exec(message)) === null || _j === void 0 ? void 0 : _j[0]) || '' };
                    }
                    result.push({
                        file,
                        type,
    ...
    removeChannel(cid, shouldStopWatching = true) {
        ...
        if (shouldStopWatching) {
            ...
            void ((_a = this.chatClientService.chatClient.activeChannels[cid]) === null || _a === void 0 ? void 0 : _a.stopWatching().catch((err) => this.chatClientService.chatClient.logger('warn', 'Failed to unwatch channel', err)));
        }
        if (remainingChannels.length < this.channels.length) {
            this.channelsSubject.next(remainingChannels);
            if (cid === ((_b = this.activeChannelSubject.getValue()) === null || _b === void 0 ? void 0 : _b.cid)) {
            ...
            case 'connection.recovered': {
                void this.ngZone.run(() => __awaiter(this, void 0, void 0, function* () {
                    ...
                    try {
                        ...
                        yield this.queryChannels(shoulSetActiveChannel || false, 'recover-state');
    ...
    addChannelFromNotification(channelResponse) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield newChannel.watch().catch((err) => {
    ...
    messageReactionEventReceived(e) {
        this.ngZone.run(() => {
            ...
            message.reaction_groups = Object.assign({}, (_e = e.message) === null || _e === void 0 ? void 0 : _e.reaction_groups);
    ...
    queryChannels(shouldSetActiveChannel, queryType) {
        var _a;
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                const { channels, hasMorePage } = yield ('query' in this.channelQuery
                ...
                (_a = this.dismissErrorNotification) === null || _a === void 0 ? void 0 : _a.call(this);
                return channels;
            }
            catch (error) {
    ...
    _init(settings) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                const result = yield this.queryChannels(this.shouldSetActiveChannel, 'first-page');
                return result;
            }
            catch (error) {
...
class AttachmentService {
    constructor(channelService, notificationService, chatClientService, messageService) {
        ...
        this.attachmentsCounter$.subscribe((count) => {
            ...
            if (count > this.maxNumberOfAttachments) {
                ...
                (_a = this.attachmentLimitNotificationHide) === null || _a === void 0 ? void 0 : _a.call(this);
            }
        });
    }
    /**
    ...
    filesSelected(fileList) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (!(yield this.areAttachmentsHaveValidExtension(files))) {
                return false;
            }
            if (!(yield this.areAttachmentsHaveValidSize(files))) {
                return false;
            }
            const imageFiles = [];
            const dataFiles = [];
    ...
    areAttachmentsHaveValidExtension(files) {
        return __awaiter(this, void 0, void 0, function* () {
            if (!this.appSettings) {
                try {
                    yield this.chatClientService.getAppSettings();
                }
                catch (error) {
                    return true;
                }
    ...
    areAttachmentsHaveValidSize(files) {
        var _a, _b, _c, _d;
        return __awaiter(this, void 0, void 0, function* () {
            if (!this.appSettings) {
                try {
            ...
            const imageSizeLimitInBytes = ((_b = (_a = this.appSettings) === null || _a === void 0 ? void 0 : _a.image_upload_config) === null || _b === void 0 ? void 0 : _b.size_limit) || 0;
            const imageSizeLimiString = `${imageSizeLimitInBytes / (1024 * 1024)}MB`;
            const fileSizeLimitInBytes = ((_d = (_c = this.appSettings) === null || _c === void 0 ? void 0 : _c.file_upload_config) === null || _d === void 0 ? void 0 : _d.size_limit) || 0;
...
class MessageActionsService {
    constructor(chatClientService, notificationService, channelService) {
        ...
        this.defaultActions = [
            ...
            },
            {
                ...
                isVisible: (_, __, message) => {
                    var _a;
                    const isClipboardSupported = ((_a = navigator === null || navigator === void 0 ? void 0 : navigator.clipboard) === null || _a === void 0 ? void 0 : _a.write) !== undefined;
                ...
                actionHandler: (message, extraParams) => {
                    ...
                    void navigator.clipboard.write([
                        new ClipboardItem({
                            'text/plain': new Blob([
                                ((_a = extraParams.messageTextHtmlElement) === null || _a === void 0 ? void 0 : _a.innerText) ||
                                    fallbackContent,
                            ], { type: 'text/plain' }),
                            'text/html': new Blob([
                                ((_b = extraParams.messageTextHtmlElement) === null || _b === void 0 ? void 0 : _b.innerHTML) ||
                                    fallbackContent,
                            ], { type: 'text/html' }),
                        }),
                    ]);
        ...
        combineLatest([
            ...
            if (messageToEdit &&
                (!activeChannel || (activeChannel === null || activeChannel === void 0 ? void 0 : activeChannel.cid) !== messageToEdit.cid)) {
...
class MessageReactionsService {
     ...
     */
    queryReactions(messageId, type, next) {
        return __awaiter(this, void 0, void 0, function* () {
            if (!this.chatClientService.chatClient) {
                ...
                try {
                    const response = yield this.chatClientService.chatClient.queryReactions(messageId, { type }, { created_at: -1 }, { next });
                    return response;
                }
                catch (error) {
                    this.notificationService.addTemporaryNotification('streamChat.Error loading reactions');
...
class MessageActionsBoxComponent {
    ...
    getReactionSelectorTemplateContext() {
        ...
        return {
            ...
            ownReactions: ((_b = this.message) === null || _b === void 0 ? void 0 : _b.own_reactions) || [],
        };
    }
...
class MessageReactionsComponent {
            ...
            if (this.messageReactionCounts && !this.messageReactionGroups) {
                ...
                Object.keys(this.messageReactionCounts).forEach((k) => {
                    ...
                    this.messageReactionGroups[k] = {
                        count: (_b = (_a = this.messageReactionCounts) === null || _a === void 0 ? void 0 : _a[k]) !== null && _b !== void 0 ? _b : 0,
                        sum_scores: (_d = (_c = this.messageReactionCounts) === null || _c === void 0 ? void 0 : _c[k]) !== null && _d !== void 0 ? _d : 0,
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (this.messageReactionsService.customReactionClickHandler) {
                ...
                if (!this.usersByReactions[this.selectedReactionType]) {
                    ...
                    yield this.loadNextPageOfReactions();
                }
            }
        });
    }
    loadNextPageOfReactions() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            this.isLoading = true;
            try {
                const response = yield this.messageReactionsService.queryReactions(this.messageId, this.selectedReactionType, this.usersByReactions[this.selectedReactionType].next);
    ...
    setExistingReactions() {
        var _a;
        this.existingReactions = Object.keys((_a = this.messageReactionGroups) !== null && _a !== void 0 ? _a : {})
...
class MessageComponent {
    ...
    ngOnInit() {
        ...
        this.subscriptions.push(this.channelService.activeChannel$.subscribe((activeChannel) => {
            var _a, _b;
            const newChannelMemberCount = (_a = activeChannel === null || activeChannel === void 0 ? void 0 : activeChannel.data) === null || _a === void 0 ? void 0 : _a.member_count;
            if (newChannelMemberCount !== this.channelMemberCount) {
                ...
                this.channelMemberCount = (_b = activeChannel === null || activeChannel === void 0 ? void 0 : activeChannel.data) === null || _b === void 0 ? void 0 : _b.member_count;
                if (this.message &&
                    this.message.cid === (activeChannel === null || activeChannel === void 0 ? void 0 : activeChannel.cid) &&
                    shouldUpdateText) {
    ...
    ngAfterViewInit() {
        var _a;
        this.isViewInited = true;
        if (this.hasTouchSupport && ((_a = this.messageBubble) === null || _a === void 0 ? void 0 : _a.nativeElement)) {
            this.ngZone.runOutsideAngular(() => {
        ...
        this.subscriptions.push(this.messageActionsService.messageMenuOpenedFor$.subscribe((id) => {
            var _a, _b;
            if ((id === undefined || ((_a = this.message) === null || _a === void 0 ? void 0 : _a.id) !== id) &&
    ...
    messageBubbleClicked(event) {
        ...
        if (this.shouldPreventMessageMenuClose) {
            ...
            (_a = this.messageMenuTrigger) === null || _a === void 0 ? void 0 : _a.hide();
        }
    }
    messageOptionsButtonClicked() {
        ...
        if (this.messageActionsService.customActionClickHandler) {
            this.messageActionsService.customActionClickHandler({
                ...
                messageTextHtmlElement: (_a = this.messageTextElement) === null || _a === void 0 ? void 0 : _a.nativeElement,
            });
        }
        else {
    ...
    getMessageReactionsContext() {
        ...
        return {
            ...
            messageReactionGroups: ((_e = this.message) === null || _e === void 0 ? void 0 : _e.reaction_groups) || {},
        };
    }
    messageClicked() {
        var _a, _b, _c, _d;
    ...
    updateReadByText() {
        ...
        const hasMoreThan100Members = ((_a = this.channelMemberCount) !== null && _a !== void 0 ? _a : 0) > 100;
        this.readByText = ((_b = this.message) === null || _b === void 0 ? void 0 : _b.readBy)
...
class MessageInputComponent {
    ...
    itemsPasted(event) {
        ...
        if (this.configService.customPasteEventHandler) {
            ...
            if (((_a = event.clipboardData) === null || _a === void 0 ? void 0 : _a.files) && ((_b = event.clipboardData) === null || _b === void 0 ? void 0 : _b.files.length) > 0) {
                event.preventDefault();
                void this.filesSelected((_c = event.clipboardData) === null || _c === void 0 ? void 0 : _c.files);
            }
        }
    }
    filesSelected(fileList) {
    ...
    setMessages$() {
        ...
        this.messages$ = this.virtualizedList.virtualizedItems$.pipe(tap(() => {
            ...
            if (this.isJumpingToLatestUnreadMessage &&
                ...
                if (lastReadIndex !== -1) {
                    this.firstUnreadMessageId = (_a = messages[lastReadIndex + 1]) === null || _a === void 0 ? void 0 : _a.id;
                }
            }
        }), tap((messages) => {
            var _a;
